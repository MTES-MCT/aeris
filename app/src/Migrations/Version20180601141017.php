...
class Version20180601141017 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_totale TYPE NUMERIC(20, 10)');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_totale DROP DEFAULT');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_dangereux TYPE NUMERIC(20, 10)');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_dangereux DROP DEFAULT');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_dasri TYPE NUMERIC(20, 10)');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_dasri DROP DEFAULT');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_non_dangereux TYPE NUMERIC(20, 10)');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_non_dangereux DROP DEFAULT');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_non_dangereux_menagers TYPE NUMERIC(20, 10)');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_non_dangereux_menagers DROP DEFAULT');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_non_dangereux_refus_tri TYPE NUMERIC(20, 10)');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_non_dangereux_refus_tri DROP DEFAULT');
        $this->addSql('ALTER TABLE declaration_dechets ALTER qtite_incineree_dechets_non_dangereux_dae TYPE NUMERIC(20, 10)');
